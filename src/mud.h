...
typedef enum
{
   ...
   ITEM_MATERIA, /* Magic items */
   ITEM_GATHERING_TOOL, /* Fishing poles, mining picks, other gathering gear */
   ...
   ITEM_BLOOD, ITEM_BLOODSTAIN, ITEM_SCRAPS, ITEM_RELIC, ITEM_HERB_CON,
